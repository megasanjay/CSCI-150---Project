...
void statsCheck()
{
    ...
    cout << "Statistics as of : " << asctime(curtime) << endl;
...
void updateStats()
{
    ...
    outfile.open("/Users/Sanjay/Documents/CSCI 150 - Project/Project/Project/Statistics.txt", ios::app);
    
    struct tm * curtime = localtime ( &_tm );
    
    outfile << endl << divider.str();
    outfile << "The below statistics were recorded at : " << asctime(curtime) << endl;
